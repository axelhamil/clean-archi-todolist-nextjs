...
export const deleteTodoUseCase = async (input: { id: string }, userId: string): Promise<string> => {
  return await startSpan({
    ...
    if(todo.userId !== userId) throw new UnauthorizedError("Cannot delete todo, because: unauthorized");
